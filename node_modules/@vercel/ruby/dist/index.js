...
const getStream = __webpack_require__(110);
...
const execa_1 = __importDefault(__webpack_require__(396));
...
const npmRunPath = __webpack_require__(65);
...
const pFinally = __webpack_require__(513);
...
const install_ruby_1 = __webpack_require__(277);
...
async function build({ workPath, files, entrypoint, config, meta = {}, }) {
    ...
    const originalRbPath = path_1.join(__dirname, '..', 'now_init.rb');
    const originalNowHandlerRbContents = await fs_extra_1.readFile(originalRbPath, 'utf8');
    ...
    const nowHandlerRbContents = originalNowHandlerRbContents.replace(/__NOW_HANDLER_FILENAME/g, userHandlerFilePath);
    ...
    await fs_extra_1.writeFile(path_1.join(workPath, `${nowHandlerRbFilename}.rb`), nowHandlerRbContents);
