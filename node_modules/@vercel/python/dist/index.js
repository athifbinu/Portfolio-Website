...
const install_1 = __webpack_require__(131);
...
exports.build = async ({ workPath, files: originalFiles, entrypoint, meta = {}, config, }) => {
    ...
    const originalPyPath = __webpack_require__.ab + "now_init.py";
    const originalNowHandlerPyContents = await readFile(__webpack_require__.ab + "now_init.py", 'utf8');
    ...
    await writeFile(path_1.join(workPath, `${nowHandlerPyFilename}.py`), nowHandlerPyContents);
